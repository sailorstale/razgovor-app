...
(function () {
  ...
  // Стопка комментариев одна на всех, и лежит она в отдельной службе. Так один и
  // тот же макет показывает одинаковые пины, откуда бы его ни открыли: с боевого
  // адреса или с прототипа на своей машине. Служба живёт отдельно от приложения,
  // потому что приложение — это только файлы и хранить ничего не умеет.
  var COMMENTS_HOST = 'https://razgovor-comments.125047.workers.dev';
  ...
  function apiUrl(p) {
    if (!wantsLocalComments()) return COMMENTS_HOST + '/' + p;
