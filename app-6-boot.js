...
// Опись записанных голосов — маленький файл, читаем его при запуске, чтобы к
// первому нажатию карточки голос уже был готов и не пришлось ничего ждать.
// Наружу при этом ничего не уходит: записи лежат рядом с приложением.
if(typeof window!=='undefined'){
  loadVoiceBank().then(()=>{ if(typeof renderSpeech==='function') renderSpeech(); });
}
